...
function Section7() {
    return (
      ...
      <div className="all-7">
        <div className="Header-7">Review của khách hàng</div>     
        <div className="user-rating-table">
          <Row>
            <Col xs={12} md={4} className="mb-3">
              <Card>
                <Card.Img className="user-rating-image" variant="top" src="https://storage.googleapis.com/cdn-entrade/bovagau-meme/shocked_black_guy_1713933316" />
                <Card.Body>
